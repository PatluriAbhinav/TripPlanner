...
public class DPnum {
	...
	CSVReader BusDet = new CSVReader(new FileReader("C:\\Users\\AbhinavPatluri\\Desktop\\ramdelhi.csv"));
	
	CSVWriter finDet = new CSVWriter(new FileWriter("C:\\Users\\AbhinavPatluri\\Desktop\\delhi.csv"));
	...
	while ((BusNum = BusDet.readNext()) != null) {
		...
		try {DSnum  ram = new DSnum(BusNum[1],BusNum[0]);
