...
public class BengScrap{
	String rows[]= new String[100];
	public BengScrap(String var) throws ClientProtocolException, IOException{

		HttpClient http = new DefaultHttpClient();
		HttpPost post = new HttpPost("http://narasimhadatta.info/cgi-bin/find.cgi");
		
		List<NameValuePair> lot = new ArrayList<NameValuePair>();
		lot.add(new BasicNameValuePair("route", var));
...
//	System.out.println(line);
	...
	int x=2;
try{		
		Elements links = (Elements) doc.getElementsByTag("li");
