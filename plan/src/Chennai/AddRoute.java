...
public class AddRoute{
	...
	public static void main(String args[]) throws IOException{
		...
		CSVReader stops = new CSVReader(new FileReader("C:\\Users\\AbhinavPatluri\\Desktop\\chennaiStop.csv"));
		CSVReader paths = new CSVReader(new FileReader("C:\\Users\\AbhinavPatluri\\Desktop\\Chennai.csv"));
		CSVWriter write = new CSVWriter(new FileWriter("C:\\Users\\AbhinavPatluri\\Desktop\\chennaiRoute.csv"));
